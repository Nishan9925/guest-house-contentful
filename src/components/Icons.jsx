...
export function PhoneIcon({ size = 18, phoneNumber, iconColor, textColor }) {
  return (
    <Link
    ...
    >
      ...
      <p className={`text-base ${textColor} md:text-start text-center`}>
        {phoneNumber}
      </p>
    </Link>
  )
...
export function EnvelopeIcon({ size = 18, email, iconColor, textColor }) {
  return (
    <Link
      href={`mailto:${email}`}
      rel="noopener noreferrer"
